...
**TypeScript (generated bindings + CosmJS)**:

Generate the message types from the [`structsd`](https://github.com/playstructs/structsd) repo with `make proto-gen-ts`, register them with CosmJS, and sign with a `SigningStargateClient`:

```typescript
import { OfflineSigner, Registry } from '@cosmjs/proto-signing';
import { SigningStargateClient } from '@cosmjs/stargate';
// Generated by `make proto-gen-ts` in the structsd repo:
import { MsgStructBuildInitiate } from './generated/structs/structs/tx';

const signer: OfflineSigner = /* get signer from Keplr or other wallet */;

const registry = new Registry();
registry.register('/structs.structs.MsgStructBuildInitiate', MsgStructBuildInitiate);
...
const msg = {
  ...
  value: {
    ...
    playerId: '1-11',
    structTypeId: 1,
    operatingAmbit: 2, // ambit enum: water 1, land 2, air 3, space 4
    slot: 0
  }
};
