...
- **Per-skill Safety callouts** on all 11 affected skills ([`structs-onboarding`](.cursor/skills/structs-onboarding/SKILL.md), [`structs-mining`](/skills/structs-production/SKILL.html), [`structs-building`](.cursor/skills/structs-building/SKILL.md), [`structs-combat`](.cursor/skills/structs-combat/SKILL.md), [`structs-economy`](/skills/structs-commerce/SKILL.html), [`structs-energy`](.cursor/skills/structs-energy/SKILL.md), [`structs-power`](/skills/structs-energy/SKILL.html), [`structs-guild`](.cursor/skills/structs-guild/SKILL.md), [`structs-diplomacy`](/skills/structs-guild/SKILL.html), [`structs-exploration`](/skills/structs-planets-fleet/SKILL.html), [`structs-guild-stack`](.cursor/skills/structs-guild-stack/SKILL.md)). Each callout lists the skill's highest-impact ops with their tier and in-character flavor.
