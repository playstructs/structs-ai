...
- [`config/operator.md`](https://github.com/playstructs/structs-ai/blob/main/config/operator.example.md) — where your standing orders live ([`COMMANDER.md`](../COMMANDER.md) is a stub)
