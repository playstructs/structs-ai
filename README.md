...
| **Full Load** | [`llms-full.txt`](llms-full.txt) | All key content in one fetch (~200KB) |
...
**Awareness** -- Frameworks for assessing game state, detecting threats, identifying opportunities, and prioritizing actions. Includes context handoff for long sessions and cross-session continuity. See [`awareness/`](awareness/).
...
**5X Gameplay**: Explore, Extract, Expand, Exterminate, Exchange.
