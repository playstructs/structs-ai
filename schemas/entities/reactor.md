...
| owner | string | entity-id | `^1-[0-9]+$` | No | PlayerId of the reactor owner. |
...
**Database Reference**: `structs.reactor` table (columns: `id`, `validator`, `guild_id`, `default_commission`, `owner`)
