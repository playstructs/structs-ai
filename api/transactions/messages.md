...
Skills: [play-structs](https://structs.ai/skills/play-structs/SKILL) for the first path; pick the domain skill for the rest.

## Address and player

| Msg | CLI | Skill / notes |
|-----|-----|----------------|
| `MsgAddressRegister` | `address-register` | [permissions](https://structs.ai/skills/structs-permissions/SKILL) |
| `MsgAddressRevoke` | `address-revoke` | |
| `MsgPlayerUpdatePrimaryAddress` | `player-update-primary-address` | Needs `PermAll` on the signer |
| `MsgPlayerUpdateGuildRank` | `player-update-guild-rank` | [guild](https://structs.ai/skills/structs-guild/SKILL) |
...
| Msg | CLI | Notes |
|-----|------|--------|
| `MsgPlanetExplore` | `planet-explore` | [onboarding](https://structs.ai/skills/structs-onboarding/SKILL) |
| `MsgPlanetUpdateName` | `planet-update-name` | |
| `MsgPlanetRaidComplete` | `planet-raid-complete` | Prefer `planet-raid-compute`; [combat](https://structs.ai/skills/structs-combat/SKILL) |
...
| Msg | CLI | Notes |
|-----|------|--------|
| `MsgStructBuildInitiate` | `struct-build-initiate` | [building](https://structs.ai/skills/structs-building/SKILL) |
...
| Msg | CLI | Notes |
|-----|------|--------|
| `MsgReactorInfuse` | `reactor-infuse` | [energy](https://structs.ai/skills/structs-energy/SKILL) |
...
| `MsgProviderCreate` | `provider-create` | [commerce](https://structs.ai/skills/structs-commerce/SKILL) |
...
- **CLI compute wrappers** — `struct-build-compute`, `struct-ore-mine-compute`, `struct-ore-refine-compute`, `planet-raid-compute`, `guild-create-compute`, `guild-charter-consent`. See [conventions](https://structs.ai/skills/conventions) and [generated/commands.md](https://github.com/playstructs/structs-ai/blob/main/generated/commands.md).
